 ...
 *       &lt;sequence>
 *         &lt;element name="return" type="{http://reservation.lab06.aipi.cs.pub.ro/}ReservationData" maxOccurs="unbounded" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
public class GetReservationsResponse {
    ...
    protected List<ReservationData> _return;
     ...
     * 
     */
    public List<ReservationData> getReturn() {
        if (_return == null) {
            _return = new ArrayList<ReservationData>();
        }
        return this._return;
    }
