 ...
 * 
 */
@WebServiceClient(name = "Reservation", targetNamespace = "http://reservation.lab06.aipi.cs.pub.ro/", wsdlLocation = "http://localhost:8080/ReservationService/Reservation?wsdl")
    ...
    extends Service
{
    ...
    static {
        ...
        try {
            url = new URL("http://localhost:8080/ReservationService/Reservation?wsdl");
