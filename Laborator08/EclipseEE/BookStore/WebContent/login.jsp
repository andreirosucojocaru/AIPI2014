	            ...
	            <div id="wrappermiddle">
	                ...
	                <div id="username_input">
	                    ...
	                    <div id="field_inputmiddle">
	                        <input type="text" name="<%= Constants.USER_NAME %>" id="url" value="<%= Constants.USER_NAME %>" onclick="this.value = ''" />
	                ...
	                <div id="password_input">
	                    <div id="field_inputleft"></div>
	                    <div id="field_inputmiddle">
	                        <input type="password" name="<%= Constants.USER_PASSWORD %>" id="url" value="<%= Constants.USER_PASSWORD %>" onclick="this.value = ''" />
	                        <img id="url_field" src="./images/user_interface/password.png" alt="" />
	                    </div>
	                    <div id="field_inputright"></div>
	                </div>
	                <div id="submit">
	                    <input type="image" src="./images/user_interface/signin.png" id="submit2" name="<%= Constants.SIGNIN.toLowerCase() %>" value="<%= Constants.SIGNIN %>" />
	                </div>
